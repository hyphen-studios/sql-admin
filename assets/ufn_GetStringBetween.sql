...
AS
/******************************************************************************
*  Stored Procedure Name: ufn_GetStringBetween
*  Input Parameters: none
*  Use Case: select ufn_GetStringBetween('StringtoSearch', '1stStringPattern', '2ndStringPattern')
*  select ufn_GetStringBetween('.....Str1ccccccStr2......', 'Str1', 'Str2')
*  Results --> cccccc
*
